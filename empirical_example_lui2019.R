...
######## R script for Empirical Example ########
...
lui2018_dat <- haven::read_sav("https://osf.io/download/wxjsg/")
dat <- lui2018_dat %>%
...
# confidence interval of the path coefficient estimate
lm_b_ci
fspa_b_ci
sem_b_ci
tspar_b_ci
